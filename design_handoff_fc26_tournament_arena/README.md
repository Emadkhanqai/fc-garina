...
- **6,000 Monte Carlo runs.** Each run simulates every remaining league fixture, ranks the table with the real tiebreakers (points → GD → goals), seeds SF1 (1 v 4) / SF2 (2 v 3), and plays both semis; a team is counted when it appears in the final. With 3 active teams the top two go straight to the final; with 2, both sit at 100%.
